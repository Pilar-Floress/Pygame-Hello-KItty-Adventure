...
class enemigo():
    ...
    def update(self, pantalla, lista_plataformas, lista_proyectiles, personaje, lista_enemigos):
        ...
        self.daños(lista_proyectiles, personaje, lista_enemigos)
    ...
    def daños(self, lista_proyectiles, personaje, lista):
        ...
        if self.vidas == 0 and not self.eliminado:
            self.eliminado = True
            personaje.puntos += 10
            self.muerte = pygame.mixer.Sound("musica\XSE01119.WAV.wav")
            self.muerte .play() 
            lista.remove(self)
            print("Chau enemigo")

# musica\XSE01119.WAV.wav

# # Humberto = enemigo((284, 545),(597, 557),diccionario_enemigo, Tamaño_enemigo, 1)
...
# Enemigos = [ enemigo_dos, enemigo_tres]

# lista_enemigos_completa = [Humberto, enemigo_dos, enemigo_tres]
# lista_enemigos_completa = [ enemigo_dos, enemigo_tres]
